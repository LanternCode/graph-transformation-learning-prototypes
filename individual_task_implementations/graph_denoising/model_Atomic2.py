"""
These scripts are early exploratory prototypes for knowledge-graph noise detection on 
GOLD/ATOMIC/ConceptNet-style data.

They were used to test feasibility of combining BERT text embeddings,
GraphSAGE/RGCN-style message passing, hard negative mining, and Recall@k-style ranking
for noisy triple detection.

They are not leakage-free benchmark implementations. The code is preserved as
a research-process artifact showing early modelling attempts, not as final experimental evidence.
"""
import os
import subprocess
import torch
