...
def make_spanning_candidate(n_nodes, feat_dim=16):
    T = nx.random_tree(n_nodes, seed=random.randint(0,1e6))
...
if __name__ == '__main__':
    # ─── (2) Build loaders ─────────────────────────────────────────────────────────
    train_loader = DataLoader(make_dataset(800, seed=42), batch_size=8, shuffle=True)
    val_loader = DataLoader(make_dataset(100, seed=43), batch_size=8)
    test_loader = DataLoader(make_dataset(100, seed=44), batch_size=8)
